...
## QUALIFICATIONS
---
* Over 10 years of experience in information security (AppSec, SecOps, OffSec)
* Senior Software Engineer with over a decade of experience in software development
* Experience working in large, multi-geo as well as focused, fast-paced, startup-like environments
* [Certified Information Systems Security Professional (CISSP)](https://www.credly.com/badges/009fef2c-32bf-4620-a94a-9a189385eca6/public_url){:target="_blank" rel="noopener"}
* [Offensive Security Certified Professional (OSCP)](https://www.credly.com/badges/abf67ae6-2563-40ea-92d2-ed8385fd0856/public_url){:target="_blank" rel="noopener"}
* [AWS Certified Security - Specialty](https://www.credly.com/badges/33b69019-e890-4216-9492-2f124d4bedae/public_url){:target="_blank" rel="noopener"}
* [Master of Applied Science in Information Systems Security](https://spectrum.library.concordia.ca/978133/){:target="_blank" rel="noopener"}
* Solid understanding of computer hardware and networking systems with a background in electronics/telecommunications
...
* *Participated* in projects in collaboration with different organizations:
  ...
  * Spam Campaign Analysis: Researched, designed and implemented a [spam campaign detection, analysis and investigation software framework](https://publications.gc.ca/site/eng/9.818785/publication.html){:target="_blank" rel="noopener"} which is utilized to enforce the Canada’s Anti-Spam Legislation
...
{:.nospace}
*Thesis*: [Mining Cyber Security Intelligence from Spam Data](https://spectrum.library.concordia.ca/978133/){:target="_blank" rel="noopener"}
{:.nospace .noprint}
...
{:.nospace .print}
**Enquêtes sur les pourriels avec le forage de données** - Délinquance et innovation, Les Presses de l'Université de Montréal ([book](https://www.pum.umontreal.ca/catalogue/delinquance-et-innovation){:target="_blank" rel="noopener"})
{:.nospace .noprint}
...
{:.nospace .print}
**Spam Campaign Detection, Analysis and Investigation** - Digital Investigation, Volume 12, Supplement 1 ([paper](https://www.sciencedirect.com/science/article/pii/S1742287615000079){:target="_blank" rel="noopener"}); Proceedings of the Second Annual DFRWS Europe ([paper](https://dfrws.org/sites/default/files/session-files/2015_EU_paper-spam_campaign_detection_analysis_and_investigation.pdf){:target="_blank" rel="noopener"} | [slides](https://dfrws.org/sites/default/files/session-files/2015_EU_pres-spam_campaign_detection_analysis_and_investigation.pdf){:target="_blank" rel="noopener"})
{:.nospace .noprint}
**Investigating the Dark Cyberspace: Profiling, Threat-based Analysis and Correlation** - 7<sup>th</sup> International Conference on Risk and Security of Internet and Systems (CRiSIS)
{:.nospace .print}
**Investigating the Dark Cyberspace: Profiling, Threat-based Analysis and Correlation** - 7<sup>th</sup> International Conference on Risk and Security of Internet and Systems (CRiSIS) ([paper](https://ieeexplore.ieee.org/abstract/document/6378947){:target="_blank" rel="noopener"})
{:.nospace .noprint}
